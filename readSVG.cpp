...
namespace svg
{
    XMLElement* parseGroup(XMLElement* child, vector<SVGElement *>& svg_elements){
        ...
        while (child != nullptr){
            ...
            if (elementName == "ellipse"){
                ...
                parseGroup(child->FirstChildElement(), svg_elements);
            }
    ...
    void readSVG(const string& svg_file, Point& dimensions, vector<SVGElement *>& svg_elements)
    {
        ...
        while (child != nullptr){
            ...
            if (elementName == "ellipse"){
                ...
                child = parseGroup(child->FirstChildElement(),  svg_elements);
                cout << "Here " << endl;
            }
            if(child == nullptr){
